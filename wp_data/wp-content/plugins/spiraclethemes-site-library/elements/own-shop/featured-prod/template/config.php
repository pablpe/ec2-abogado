...
class Own_Shop_FeaturedProd extends Widget_Base {

	public function get_name() {
		return 'own-shop-elementor-featuredprod';
	} 

	public function get_title() {
		return __( 'Featured Products', 'spiraclethemes-site-library' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_list_featured_prod',
			[
				'label' => esc_html__( 'Featured Products', 'spiraclethemes-site-library' ),
			]
		);
	...
	protected function render() {
		require SPIR_SITE_LIBRARY_PATH . '/elements/own-shop/featured-prod/template/view.php';
	}
}
