...
class Own_Shop_NewProd extends Widget_Base {
	...
	public function get_title() {
		return __( 'New Products', 'spiraclethemes-site-library' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_list_new_prod',
			[
				'label' => esc_html__( 'New Products', 'spiraclethemes-site-library' ),
			]
		);
	...
	protected function render() {
		require SPIR_SITE_LIBRARY_PATH . '/elements/own-shop/new-prod/template/view.php';
	}
}
