...
if ( ! function_exists( 'spiraclethemes_site_library_own_shope_set_import_files' ) ) :
function spiraclethemes_site_library_own_shope_set_import_files() {

    $customizer_ownshope_demo1 = spiraclethemes_site_library_api_data('ownshope', 'demo1', 'customizer');
    $widgets_ownshope_demo1 = spiraclethemes_site_library_api_data('ownshope', 'demo1', 'widgets');
    $content_ownshope_demo1 = spiraclethemes_site_library_api_data('ownshope', 'demo1', 'content');
    $image_ownshope_demo1 = spiraclethemes_site_library_api_data('ownshope', 'demo1', 'image');

	return array(
        array(
            'import_file_name'           => esc_html__('Own Shope Demo', 'spiraclethemes-site-library'),
            'import_file_url'          => $content_ownshope_demo1,
...
add_filter( 'pt-ocdi/import_files', 'spiraclethemes_site_library_own_shope_set_import_files' );
...
if ( ! function_exists( 'spiraclethemes_site_library_own_shope_after_import_setup' ) ) :
function spiraclethemes_site_library_own_shope_after_import_setup( $selected_import ) {
...
add_action( 'pt-ocdi/after_import', 'spiraclethemes_site_library_own_shope_after_import_setup' );
...
add_action( 'admin_init', 'spiraclethemes_site_library_own_shope_check_pro_plugin' );
