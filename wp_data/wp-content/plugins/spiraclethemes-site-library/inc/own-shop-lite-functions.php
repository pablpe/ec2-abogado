...
function spiraclethemes_site_library_own_shop_lite_set_import_files() {
    ...
    $customizer_ownshoplite_demo1 = spiraclethemes_site_library_api_data('ownshoplite', 'demo1', 'customizer');
    $widgets_ownshoplite_demo1 = spiraclethemes_site_library_api_data('ownshoplite', 'demo1', 'widgets');
    $content_ownshoplite_demo1 = spiraclethemes_site_library_api_data('ownshoplite', 'demo1', 'content');
    $image_ownshoplite_demo1 = spiraclethemes_site_library_api_data('ownshoplite', 'demo1', 'image');

	return array(
        array(
            'import_file_name'           => esc_html__('Own Shop Lite Demo', 'spiraclethemes-site-library'),
           'import_file_url'          => $content_ownshoplite_demo1,
